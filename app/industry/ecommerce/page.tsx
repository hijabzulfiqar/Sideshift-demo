...
import {
  ecommerceHeroOverrides,
  ecommerceWhyUgc,
  ecommerceUgcComparison,
  ecommerceComparisonRows,
  ecommercePricing,
  ecommerceFaqContent,
  ecommerceFaqData,
  ecommerceArticles,
  ecommerceArticlesContent,
} from "@/data/industry/ecommerce";
...
export default function EcommerceIndustryPage() {
  return (
    <>
      ...
      <main>
        <Hero isCreator={false} overrides={ecommerceHeroOverrides} />
        ...
        <SideShiftCreators
          ...
          heading="E-Commerce Creator Content"
          subheading="Authentic UGC from creators driving e-commerce sales"
          badgeLabel="E-Commerce"
          defaultCategory="fashion"
          hideFilters
        />
        <WhyUgc content={ecommerceWhyUgc} />
        <Testimonials isCreator={false} />
        <SanityCaseStudyRow />
        <ComparisonTable />
        <PricingSnapshot
          heading={ecommercePricing.heading}
          subheading={ecommercePricing.subheading}
        />
        <UgcComparison
          content={ecommerceUgcComparison}
          rows={ecommerceComparisonRows}
        />
        <FAQ
          isCreator={false}
          customFaqData={ecommerceFaqData}
          customHeading={ecommerceFaqContent.heading}
          customSubheading={ecommerceFaqContent.subheading}
        />
        <RelatedArticles
          content={ecommerceArticlesContent}
          articles={ecommerceArticles}
        />
        <Cta isCreator={false} />
      </main>
