...
import {
  healthWellnessHeroOverrides,
  healthWellnessWhyUgc,
  healthWellnessUgcComparison,
  healthWellnessComparisonRows,
  healthWellnessPricing,
  healthWellnessFaqContent,
  healthWellnessFaqData,
  healthWellnessArticles,
  healthWellnessArticlesContent,
} from "@/data/industry/health-wellness";
...
export default function HealthWellnessIndustryPage() {
  return (
    <>
      ...
      <main>
        <Hero isCreator={false} overrides={healthWellnessHeroOverrides} />
        ...
        <SideShiftCreators
          ...
          heading="Health & Wellness Creator Content"
          subheading="Authentic UGC from creators driving growth in health & wellness"
          badgeLabel="Health"
          defaultCategory="health"
          hideFilters
        />
        <WhyUgc content={healthWellnessWhyUgc} />
        <Testimonials isCreator={false} />
        <SanityCaseStudyRow />
        <ComparisonTable />
        <PricingSnapshot
          heading={healthWellnessPricing.heading}
          subheading={healthWellnessPricing.subheading}
        />
        <UgcComparison
          content={healthWellnessUgcComparison}
          rows={healthWellnessComparisonRows}
        />
        <FAQ
          isCreator={false}
          customFaqData={healthWellnessFaqData}
          customHeading={healthWellnessFaqContent.heading}
          customSubheading={healthWellnessFaqContent.subheading}
        />
        <RelatedArticles
          content={healthWellnessArticlesContent}
          articles={healthWellnessArticles}
        />
        <Cta isCreator={false} />
      </main>
