...
import {
  fintechHeroOverrides,
  fintechWhyUgc,
  fintechUgcComparison,
  fintechComparisonRows,
  fintechPricing,
  fintechFaqContent,
  fintechFaqData,
  fintechArticles,
  fintechArticlesContent,
} from "@/data/industry/fintech";
...
export default function FintechIndustryPage() {
  return (
    <>
      ...
      <main>
        <Hero isCreator={false} overrides={fintechHeroOverrides} />
        ...
        <SideShiftCreators
          ...
          heading="Fintech Creator Content"
          subheading="Authentic UGC from creators driving growth in fintech"
          badgeLabel="Fintech"
          defaultCategory="finance"
          hideFilters
        />
        <WhyUgc content={fintechWhyUgc} />
        <Testimonials isCreator={false} />
        <SanityCaseStudyRow />
        <ComparisonTable />
        <PricingSnapshot
          heading={fintechPricing.heading}
          subheading={fintechPricing.subheading}
        />
        <UgcComparison
          content={fintechUgcComparison}
          rows={fintechComparisonRows}
        />
        <FAQ
          isCreator={false}
          customFaqData={fintechFaqData}
          customHeading={fintechFaqContent.heading}
          customSubheading={fintechFaqContent.subheading}
        />
        <RelatedArticles
          content={fintechArticlesContent}
          articles={fintechArticles}
        />
        <Cta isCreator={false} />
      </main>
