...
import {
  ...
  travelWhyUgc,
  travelUgcComparison,
  travelComparisonRows,
  travelPricing,
  travelFaqContent,
  travelFaqData,
  travelArticles,
  travelArticlesContent,
} from "@/data/industry/travel-hospitality";
...
export default function TravelIndustryPage() {
  return (
    <>
      ...
      <main>
        <Hero isCreator={false} overrides={travelHeroOverrides} />
        ...
        <SideShiftCreators
          ...
          heading="Travel & Hospitality Creator Content"
          subheading="Authentic UGC from creators driving growth in travel"
          badgeLabel="Travel"
          defaultCategory="creative"
          hideFilters
        />
        <WhyUgc content={travelWhyUgc} />
        <Testimonials isCreator={false} />
        <SanityCaseStudyRow />
        <ComparisonTable />
        <PricingSnapshot
          heading={travelPricing.heading}
          subheading={travelPricing.subheading}
        />
        <UgcComparison
          content={travelUgcComparison}
          rows={travelComparisonRows}
        />
        <FAQ
          isCreator={false}
          customFaqData={travelFaqData}
          customHeading={travelFaqContent.heading}
          customSubheading={travelFaqContent.subheading}
        />
        <RelatedArticles
          content={travelArticlesContent}
