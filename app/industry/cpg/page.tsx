...
export default function CpgIndustryPage() {
  return (
    <>
      ...
      <main>
        <Hero isCreator={false} overrides={cpgHeroOverrides} />
        ...
        <SideShiftCreators
          ...
          heading="CPG Creator Content"
          subheading="Authentic UGC from creators driving growth in CPG"
          badgeLabel="CPG"
          defaultCategory="food"
          hideFilters
        />
        <WhyUgc content={cpgWhyUgc} />
        <Testimonials isCreator={false} />
        <SanityCaseStudyRow />
        <ComparisonTable />
        <PricingSnapshot
          heading={cpgPricing.heading}
          subheading={cpgPricing.subheading}
        />
        <UgcComparison
          content={cpgUgcComparison}
          rows={cpgComparisonRows}
        />
        <FAQ
          isCreator={false}
          customFaqData={cpgFaqData}
          customHeading={cpgFaqContent.heading}
          customSubheading={cpgFaqContent.subheading}
        />
        <RelatedArticles
          content={cpgArticlesContent}
          articles={cpgArticles}
        />
        <Cta isCreator={false} />
      </main>
