...
import {
  fashionHeroOverrides,
  fashionWhyUgc,
  fashionUgcComparison,
  fashionComparisonRows,
  fashionPricing,
  fashionFaqContent,
  fashionFaqData,
  fashionArticles,
  fashionArticlesContent,
} from "@/data/industry/fashion";
...
export default function FashionIndustryPage() {
  return (
    <>
      ...
      <main>
        <Hero isCreator={false} overrides={fashionHeroOverrides} />
        ...
        <SideShiftCreators
          ...
          heading="Fashion Creator Content"
          subheading="Authentic UGC from creators driving growth in fashion"
          badgeLabel="Fashion"
          defaultCategory="fashion"
          hideFilters
        />
        <WhyUgc content={fashionWhyUgc} />
        <Testimonials isCreator={false} />
        <SanityCaseStudyRow />
        <ComparisonTable />
        <PricingSnapshot
          heading={fashionPricing.heading}
          subheading={fashionPricing.subheading}
        />
        <UgcComparison
          content={fashionUgcComparison}
          rows={fashionComparisonRows}
        />
        <FAQ
          isCreator={false}
          customFaqData={fashionFaqData}
          customHeading={fashionFaqContent.heading}
          customSubheading={fashionFaqContent.subheading}
        />
        <RelatedArticles
          content={fashionArticlesContent}
