...
import {
  techSaasHeroOverrides,
  techSaasWhyUgc,
  techSaasUgcComparison,
  techSaasComparisonRows,
  techSaasPricing,
  techSaasFaqContent,
  techSaasFaqData,
  techSaasArticles,
  techSaasArticlesContent,
} from "@/data/industry/tech-saas";
...
export default function TechSaasIndustryPage() {
  return (
    <>
      ...
      <main>
        <Hero isCreator={false} overrides={techSaasHeroOverrides} />
        ...
        <SideShiftCreators
          ...
          heading="Tech & SaaS Creator Content"
          subheading="Authentic UGC from creators driving growth in tech"
          badgeLabel="Tech & SaaS"
          defaultCategory="tech"
          hideFilters
        />
        <WhyUgc content={techSaasWhyUgc} />
        <Testimonials isCreator={false} />
        <SanityCaseStudyRow />
        <ComparisonTable />
        <PricingSnapshot
          heading={techSaasPricing.heading}
          subheading={techSaasPricing.subheading}
        />
        <UgcComparison
          content={techSaasUgcComparison}
          rows={techSaasComparisonRows}
        />
        <FAQ
          isCreator={false}
          customFaqData={techSaasFaqData}
          customHeading={techSaasFaqContent.heading}
          customSubheading={techSaasFaqContent.subheading}
        />
        <RelatedArticles
          content={techSaasArticlesContent}
          articles={techSaasArticles}
        />
        <Cta isCreator={false} />
      </main>
