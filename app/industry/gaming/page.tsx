...
import {
  ...
  gamingWhyUgc,
  gamingUgcComparison,
  gamingComparisonRows,
  gamingPricing,
  gamingFaqContent,
  gamingFaqData,
  gamingArticles,
  gamingArticlesContent,
} from "@/data/industry/gaming";
...
export default function GamingIndustryPage() {
  return (
    <>
      ...
      <main>
        <Hero isCreator={false} overrides={gamingHeroOverrides} />
        ...
        <SideShiftCreators
          ...
          heading="Gaming Creator Content"
          subheading="Authentic UGC from creators driving growth in gaming"
          badgeLabel="Gaming"
          defaultCategory="gaming"
          hideFilters
        />
        <WhyUgc content={gamingWhyUgc} />
        <Testimonials isCreator={false} />
        <SanityCaseStudyRow />
        <ComparisonTable />
        <PricingSnapshot
          heading={gamingPricing.heading}
          subheading={gamingPricing.subheading}
        />
        <UgcComparison
          content={gamingUgcComparison}
          rows={gamingComparisonRows}
        />
        <FAQ
          isCreator={false}
          customFaqData={gamingFaqData}
          customHeading={gamingFaqContent.heading}
          customSubheading={gamingFaqContent.subheading}
        />
        <RelatedArticles
          content={gamingArticlesContent}
