  ...
  return (
    <>
      ...
      <main>
        ...
        {/* 6. How it works (lottie animation) */}
        <Workflow isCreator={isCreator} showCta ctaText="Book a Demo" ctaHref="#book" ctaNote="No commitment &middot; Most calls are 20 minutes" />

        {/* 7. Comparison Table */}
        <ComparisonTable heading="The New Standard for Creator Marketing" ctaText="Book a Demo" ctaHref="#book" />
        ...
        {/* 10. FAQ */}
        <FAQ isCreator={isCreator} customFaqData={faqItems} hideCta />
        ...
        <div className="px-global py-section-md pb-10">
          <div className="max-w-global mx-auto flex flex-col items-center gap-6 text-center">
            ...
            <div className="flex items-center gap-2 text-sm text-[rgba(32,32,32,0.5)]">
              <a
                href="https://sideshift.app/terms-of-service"
                target="_blank"
              ...
              <span>&middot;</span>
              <a
                href="https://sideshift.app/privacy-policy"
                target="_blank"
                className="underline transition-colors hover:text-[#202020]"
              >
                Privacy Policy
