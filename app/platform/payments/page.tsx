...
import {
  paymentsHeroOverrides,
  paymentsWhyUgc,
  paymentsUgcComparison,
  paymentsComparisonRows,
  paymentsPricing,
  paymentsFaqContent,
  paymentsFaqData,
  paymentsArticles,
  paymentsArticlesContent,
} from "@/data/platform/payments";
...
export default function PaymentsPage() {
  return (
    <>
      <Header demoMode />
      <main>
        <Hero isCreator={false} demoMode overrides={paymentsHeroOverrides} />
        ...
        <WhyUgc content={paymentsWhyUgc} />
        <Testimonials isCreator={false} demoMode />
        <PricingSnapshot demoMode
          heading={paymentsPricing.heading}
          subheading={paymentsPricing.subheading}
        />
        <UgcComparison
          content={paymentsUgcComparison}
          rows={paymentsComparisonRows}
        />
        <FAQ
          isCreator={false}
          customFaqData={paymentsFaqData}
          customHeading={paymentsFaqContent.heading}
          customSubheading={paymentsFaqContent.subheading}
        />
        <RelatedArticles
          content={paymentsArticlesContent}
