...
import {
  facebookHeroOverrides,
  facebookWhyUgc,
  facebookUgcComparison,
  facebookComparisonRows,
  facebookPricing,
  facebookFaqContent,
  facebookFaqData,
  facebookArticles,
  facebookArticlesContent,
} from "@/data/platform/facebook";
...
export default function FacebookPlatformPage() {
  return (
    <>
      ...
      <main>
        <Hero isCreator={false} overrides={facebookHeroOverrides} />
        ...
        <SideShiftCreators
          ...
          heading="Facebook Creator Content"
          subheading="Authentic UGC from creators driving engagement on Facebook"
          badgeLabel="Facebook"
        />
        <WhyUgc content={facebookWhyUgc} />
        <Testimonials isCreator={false} />
        <ComparisonTable />
        <PricingSnapshot
          heading={facebookPricing.heading}
          subheading={facebookPricing.subheading}
        />
        <UgcComparison
          content={facebookUgcComparison}
          rows={facebookComparisonRows}
        />
        <SanityCaseStudyRow />
        <FAQ
          isCreator={false}
          customFaqData={facebookFaqData}
          customHeading={facebookFaqContent.heading}
          customSubheading={facebookFaqContent.subheading}
        />
        <RelatedArticles
          content={facebookArticlesContent}
          articles={facebookArticles}
        />
        <Cta isCreator={false} />
      </main>
