...
import {
  campaignHeroOverrides,
  campaignWhyUgc,
  campaignUgcComparison,
  campaignComparisonRows,
  campaignPricing,
  campaignFaqContent,
  campaignFaqData,
  campaignArticles,
  campaignArticlesContent,
} from "@/data/platform/campaign-management";
...
export default function CampaignManagementPage() {
  return (
    <>
      <Header demoMode />
      <main>
        <Hero isCreator={false} demoMode overrides={campaignHeroOverrides} />
        ...
        <WhyUgc content={campaignWhyUgc} />
        <Testimonials isCreator={false} demoMode />
        <PricingSnapshot demoMode
          heading={campaignPricing.heading}
          subheading={campaignPricing.subheading}
        />
        <UgcComparison
          content={campaignUgcComparison}
          rows={campaignComparisonRows}
        />
        <FAQ
          isCreator={false}
          customFaqData={campaignFaqData}
          customHeading={campaignFaqContent.heading}
          customSubheading={campaignFaqContent.subheading}
        />
        <RelatedArticles
          content={campaignArticlesContent}
