...
import {
  influencerDbHeroOverrides,
  influencerDbWhyUgc,
  influencerDbUgcComparison,
  influencerDbComparisonRows,
  influencerDbPricing,
  influencerDbFaqContent,
  influencerDbFaqData,
  influencerDbArticles,
  influencerDbArticlesContent,
} from "@/data/platform/influencer-database";
...
export default function InfluencerDatabasePage() {
  return (
    <>
      <Header demoMode />
      <main>
        <Hero isCreator={false} demoMode overrides={influencerDbHeroOverrides} />
        ...
        <WhyUgc content={influencerDbWhyUgc} />
        <Testimonials isCreator={false} demoMode />
        <PricingSnapshot demoMode
          heading={influencerDbPricing.heading}
          subheading={influencerDbPricing.subheading}
        />
        <UgcComparison
          content={influencerDbUgcComparison}
          rows={influencerDbComparisonRows}
        />
        <FAQ
          isCreator={false}
          customFaqData={influencerDbFaqData}
          customHeading={influencerDbFaqContent.heading}
          customSubheading={influencerDbFaqContent.subheading}
        />
        <RelatedArticles
          content={influencerDbArticlesContent}
          articles={influencerDbArticles}
        />
