...
import {
  ...
  tiktokWhyUgc,
  tiktokUgcComparison,
  tiktokComparisonRows,
  tiktokPricing,
  tiktokFaqContent,
  tiktokFaqData,
  tiktokArticles,
  tiktokArticlesContent,
} from "@/data/platform/tiktok";
...
export default function TikTokPlatformPage() {
  return (
    <>
      ...
      <main>
        <Hero isCreator={false} overrides={tiktokHeroOverrides} />
        ...
        <SideShiftCreators
          ...
          heading="TikTok Creator Content"
          subheading="Real UGC from creators driving results on TikTok"
          badgeLabel="TikTok"
        />
        <WhyUgc content={tiktokWhyUgc} />
        <Testimonials isCreator={false} />
        <ComparisonTable />
        <PricingSnapshot
          heading={tiktokPricing.heading}
          subheading={tiktokPricing.subheading}
        />
        <UgcComparison
          content={tiktokUgcComparison}
          rows={tiktokComparisonRows}
        />
        <SanityCaseStudyRow />
        <FAQ
          isCreator={false}
          customFaqData={tiktokFaqData}
          customHeading={tiktokFaqContent.heading}
          customSubheading={tiktokFaqContent.subheading}
        />
        <RelatedArticles
          content={tiktokArticlesContent}
