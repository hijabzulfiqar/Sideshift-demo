          ...
          <div className="max-w-global mx-auto">
            <div className="flex flex-col items-center gap-4 text-center">
              ...
              <p className="max-w-[500px] text-base leading-[135%] text-[rgba(32,32,32,0.75)] md:text-lg">
                Tell us about your setup and we&apos;ll recommend the right
                path &mdash; self-serve, guided, or fully managed.
              </p>
            </div>
            ...
            <p className="mt-4 text-center text-sm text-[rgba(32,32,32,0.5)]">
              Most teams get set up in under 10 minutes &middot; No commitment
            </p>
          </div>
        </div>
      </section>
